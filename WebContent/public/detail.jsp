                     ...
                     <article id="post-98" class="post-98 post type-post status-publish format-standard has-post-thumbnail hentry category-editorial">
                        <header class="entry-header">
                           <div class="newspaper-x-image">
                              <img width="700" height="490" src="../templates/public/images/00_header_under_article_01-700x490.jpg" class="attachment-newspaper-x-single-post size-newspaper-x-single-post wp-post-image" alt=""> 
                           </div>
                           <div class="newspaper-x-post-meta">
                              <div><span class="newspaper-x-category"> <a href="https://colorlib.com/newspaper-x/category/editorial/">Editorial</a></span><span class="newspaper-x-date">May 10, 2017 </span></div>
                           </div>
                           <h2 class="entry-title">Vivamus id lorem blandit</h2>
                        </header>
